  ...
  return (
    <ImageBackground
      ...
      <View style={styles.characterRow}>
        <TouchableOpacity onPress={() => handleCharacterPress('Character1')}>
          <ImageBackground
            ...
            <Text style={[styles.characterStatus, {color: 'rgba(0,255,0,1)'}]}>
              {t('Available')}
            </Text>
          </ImageBackground>
        </TouchableOpacity>
        ...
        <TouchableOpacity onPress={() => handleCharacterPress('Character2')}>
          <ImageBackground
            ...
            style={styles.characterImage}>
            <Text style={[styles.characterStatus, {color: 'red'}]}>
              {t('In_session')}
            </Text>
          </ImageBackground>
        </TouchableOpacity>
        ...
        <TouchableOpacity onPress={() => handleCharacterPress('Character3')}>
          <ImageBackground
            ...
            style={styles.characterImage}>
            <Text style={[styles.characterStatus, {color: 'yellow'}]}>
              {t('To_finish')}
            </Text>
          </ImageBackground>
        </TouchableOpacity>
      ...
      <View style={styles.characterRow}>
        ...
        <TouchableOpacity
          onPress={() => handleCharacterPress('CreateCharacter')}>
          <ImageBackground
            source={require('../../../assets/add_new.png')}
            style={styles.characterImage}>
            <Text style={[styles.characterStatus, {color: 'white'}]}>
              {t('Create_new')}
            </Text>
          </ImageBackground>
        </TouchableOpacity>
