  ...
  const [players, setPlayers] = useState([
    {
      id: 1,
      name: 'Player 1',
      image: require('../../../assets/assasin.jpeg'),
      coins: 0,
      level: 1,
      hp: 100,
    },
    {
      id: 2,
      name: 'Player 2',
      image: require('../../../assets/archer.jpeg'),
      coins: 0,
      level: 1,
      hp: 100,
    },
  ...
  const handleAddSession = () => {
    if (newSessionName && newSessionContent) {
      const updatedSessions = [
        ...sessions,
        {name: newSessionName, content: newSessionContent},
      ];
          ...
          !addingNewSession && (
            <View style={styles.sessionContainer}>
              <View style={styles.sessionHeader}>
                ...
                <TouchableOpacity
                  onPress={() => handleEditSession(activeSessionIndex)}>
                  <Text style={styles.editText}>{t('Edit')}</Text>
                </TouchableOpacity>
                <TouchableOpacity
                  onPress={() => handleDeleteSession(activeSessionIndex)}>
                  <Text style={styles.deleteText}>{t('Delete')}</Text>
                </TouchableOpacity>
              </View>
              <Text style={styles.sessionContent}>
                {sessions[activeSessionIndex]?.content}
              </Text>
            </View>
          )}
        {(editingSession !== null || addingNewSession) && (
          <View style={styles.newSessionContainer}>
            ...
            <TouchableOpacity
              ...
              onPress={
                editingSession === null ? handleAddSession : handleSaveEdit
              }>
              <Text style={styles.buttonText}>
                {editingSession === null ? t('Add Session') : t('Save Session')}
              </Text>
            </TouchableOpacity>
          </View>
        )}
